...
type Tool = 'dashboard' | 'docs' | 'slides' | 'resume' | 'analyzer' | 'settings' | 'illustrations' | 'exam' | 'notes' | 'solver' | 'blueprint' | 'handwriting' | 'editor' | 'watermark-adder';
            ...
            <div className="px-6 py-4">
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="tools-intro">
                  ...
                  <AccordionContent className="prose prose-sm dark:prose-invert">
                     <div dangerouslySetInnerHTML={{ __html: t('helpExploreTools') + t('helpToolsDesc') + t('helpContentCreation') + t('helpToolDoc') + t('helpToolExam') + t('helpToolNotes') + t('helpToolHandwriting') + t('helpEditingAnalysis') + t('helpToolEditor') + t('helpToolSolver') + t('helpWatermark') + t('helpToolAnalyzer') + t('helpDesignUtility') + t('helpToolBlueprint') + t('helpToolResume') + t('helpToolIllustration') }} />
                  </AccordionContent>
                </AccordionItem>
