...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-[999] bg-black/80 backdrop-blur-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
  />
...
>(({ className, children, wrapperClassName, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <div className={cn("fixed inset-0 z-[1000] flex items-center justify-center p-4 pointer-events-none", wrapperClassName)}>
